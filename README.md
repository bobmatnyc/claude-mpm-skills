...
This repository contains a comprehensive collection of **167 Claude Code skills** designed for the Claude Multi-Agent Project Manager (MPM) ecosystem. Skills cover modern development workflows with **95%+ coverage** across Python, TypeScript, JavaScript, Golang, PHP, Rust, Elixir, AI, and universal tooling.
...
- **Skills**: Domain-specific knowledge modules (this repo contains 167 skills)
...
- **Total Skills**: 167 production-ready skills
